...
public:
	...
	Shader(std::filesystem::path vertexShaderPath, std::filesystem::path tesselationControlShaderPath, std::filesystem::path tesselationEvaluationControlPath, std::filesystem::path fragmentShaderPath);
